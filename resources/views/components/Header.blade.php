        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                @guest
                    @if (Route::has('login'))
                        <li class="nav-item">
                            <a href="{{ route('login') }}" class="btn btn-sm btn-primary p-8 border-0 m-6">{{ __('Login') }}</a>
                        </li>
                    @endif

                    @if (Route::has('register'))
                        <li class="nav-item">
                            <a href="{{ route('register') }}" class="btn btn-sm btn-info p-8 border-0 m-6 text-white">{{ __('Register') }}</a>
                        </li>
                    @endif
                @else
